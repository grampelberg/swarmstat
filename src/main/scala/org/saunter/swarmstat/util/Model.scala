...
class UUID[T<:Mapper[T]](
  override val fieldOwner: T) extends MappedStringIndex[T](
    fieldOwner, 20) with IndexedField[String] {
...
class UUIDForeignKey[T<:Mapper[T],O<:KeyedMapper[String, O]](
  ...
  extends MappedStringForeignKey[T,O](fieldOwner, foreign, 20) {
